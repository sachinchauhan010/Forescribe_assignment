...
export default function SignupCard() {
  return (
    <motion.div
      ...
      className="bg-black/40 dark:bg-zinc-400/40 font-sans backdrop-blur-md rounded-xl w-full p-8 lg:px-[70px] lg:py-[40px] max-w-md lg:h-[368px] lg:w-[459px] shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(32,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)]"
    >
